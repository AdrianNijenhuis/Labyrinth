...
public class CharacterSelectDisplay : NetworkBehaviour
{
    ...
    private void SelectServerRpc(int characterId, ServerRpcParams serverRpcParams = default)
    {
        for (int i = 0; i < players.Count; i++)
        {
            ...
            {
                // Retrieve, modify, and reassign the state
                CharacterSelectState currentState = players[i];
                CharacterSelectState updatedState = new CharacterSelectState(currentState.ClientId, characterId);
